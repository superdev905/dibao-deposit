        ...
        <Card sx={{ width: "100%", marginTop: 5 }}>
          <CardContent >
            ...
            <Card sx={{ width: "100%" }}>
              ...
              <Typography sx={{marginY: 3}}>Deposit is based 1000 as the base unit</Typography>
              <Grid container textAlign="center" spacing={2} paddingY={2}>
                {buttonData.map((data, index) => (
                    <DepositButton key={index} value={data.value} title={data.title} onClick={(e) => {handleAmount(e)}}/>
                ))}
              </Grid>
            </Card>
            <div style={{textAlign: "center"}}>
            <Button variant="contained" sx={{width: "100%"}}>Generate QR Code</Button>
